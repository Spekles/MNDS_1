...
namespace MNDS_lab1
{
    class Class1
    {
        ...
        {
            Console.WriteLine("Volodymyr Shyrokoradiuk, KNm-22-1");
            //Запис та зчитування параметрів геометрії кільця:
            Console.Write("Enter first diameter, mm, d0 = ");
            d0 = Convert.ToDouble(Console.ReadLine());
            Console.Write("Enter second diameter, mm, D = ");
            D = Convert.ToDouble(Console.ReadLine());
            Console.Write("Thickness of ring, mm, s = ");
            ...
            Console.Write("u[l] (mm) = ");
            Console.WriteLine(u[1]);
            Console.Write("u[7] (mm) = ");
            ...
            Console.Write("Rj (mm) = ");
            Console.WriteLine(Rj) ;
            Console.Write("sig_r[l] (N/(mm*mm)) = ");
            Console.WriteLine(sig_r[1]);
            Console.Write("sig_t[l] (N/(mm*mm)) = ");
            Console.WriteLine (sig_t[1]);
            Console.Write("sig_r[7] (N/(mm*mm)) = ");
            Console.WriteLine(sig_r[7]);
            Console.Write("sig_t[7] (N/(mm*mm)) = ");
            Console.WriteLine(sig_t[7]);
            Console.Write("sig_[l] (N/(mm*mm)) = ");
            Console.WriteLine(sig_[l]);
            Console.Write("sig_[7] (N/(mm*mm)) = ");
            Console.WriteLine(sig [7]);
            */
        ...
        public void Elasticity_FEM()
        {
            ...
            for (n = 1; n <= N_elem; n++)
            {
                ...
                for (i = 1; i <= 6; i++)
                    for (j = 1; j <= 3; j++)
                        for (m = 1; m <= 3; m++)
                            B_T_D[i, j] = B_T_D[i, j] + B_T[i, m] * D[m, j];
        ...
        Exit: //Завершення розв‘язку системи рівнянь методом Гауса
            ...
            for (n = 1; n <= N_elem; n++)
                for (k1 = 1; k1 <= 3; k1++)
                    for (ll = 1; ll <= 3; ll++)
                        sig[n, k1] = sig[n, k1] + D[k1, ll] * eps_el[n, ll];
            ...
            {
                i = i + 14;
                u_Rj[t] = U[i - 1] * Math.Cos(theta[t]) + U[i] * Math.Sin(theta[t]) * 0.2;
            }
            ...
            for (t = 1; t <= N_d_theta + 1; t++)
            {
                ...
                Console.Write(t);
                Console.Write(", ");
                Console.Write("u_rj[t] (mm) = ");
                Console.Write(u_Rj[t]);
                Console.WriteLine("");//Пустий рядок.
            }

            //Виведення радіальної деформації eps_r_mean[i]
            //на внутрішньому контурі rj:
            /*i = -6;
            for (t = 1; t <= N_d_theta + 1; t++)
            {
                i = i + 7;
                ...
                Console.Write("t =");
                Console.WriteLine(t);
                Console.Write("eps_r_mean[t] = ");
                Console.WriteLine(eps_r_mean[i]);
                
            }*/

            //Виведення тангенціальної деформації eps_t_mean[i]
            //на внутрішньому контурі rj:
            /*i = -6;
            for (t = 1; t <= N_d_theta + 1; t++)
            {
                ...
                Console.Write("t = ");
                Console.WriteLine(t);
                Console.Write("eps_t_mean[t] = ");
                Console.WriteLine(eps_t_mean[i]);
                
            }*/

            //Виведення інтенсивності деформацій eps__[і]
            //на внутрішньому контурі rj:
            /*i = -6;
            for (t = 1; t <= N_d_theta + 1; t++)
            {
                ...
                Console.Write("t = ");
                Console.WriteLine(t);
                Console.Write("eps__[t] = ");
                Console.WriteLine(eps__[i]);
                
            }*/

            //Виведення радіального напруження sig_r_mean[і]
            //на внутрішньому контурі rj;
            /*i = -6;
            for (t = 1; t <= N_d_theta + 1; t++)
            {
                ...
                Console.Write("t = ");
                Console.WriteLine(t);
                Console.Write("sig_r_mean[t] (N/(mm*mm)) = ");
                Console.WriteLine(sig_r_mean[i]);
                
            }*/

            //Виведення тангенціального напруження sig_t_mean[і]
            //на внутрішньому контурі rj:
            /*i = -6;
            for (t = 1; t <= N_d_theta + 1; t++)
            {
                ...
                Console.Write("t = ");
                Console.WriteLine(t);
                Console.Write("sig_t_mean[t] (N/(mm*mm)) = ");
                Console.WriteLine(sig_t_mean[i]);
                
            }*/

            //Виведення інтенсивності напружень sig_
            //на внутрішньому контурі rj:
            /*i = -6;
            for (t = 1; t <= N_d_theta + 1; t++)
            {
                ...
                Console.Write("t = ");
                Console.WriteLine(t);
                Console.Write("sig__[t] (N/(mm*mm)) = ");
                Console.WriteLine(sig__[i]);
